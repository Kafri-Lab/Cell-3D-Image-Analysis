function S=process3d(imStack,xyres,zres,parset)
% clear all
% load('dat5.mat');
if ~exist('xyres','var')
    xyres=0.16;
...
if ~exist('parset','var')
    ...
    maxWidth=parset.maxWidth;
    maxNS=parset.maxNS;
    bkGaussR=parset.bkGaussR;
    bkOpenR=parset.bkOpenR;
    hmaxThresh=parset.hmaxThresh;
    nucOptions=parset.nucOptions;
    plateOptions=parset.plateOptions;
    lineOptions=parset.lineOptions;
    nucGauss=parset.nucGauss;
    logThresh=parset.logThresh;
end

%%
sepFactors=1.5; %z axis may have worse resolution than slice distance
...
disp('islet cropping...')%find islet
...
%%
disp('normalization...')%need find a way to normalize among z axis
for i=1:size(rc1,3)
...
pc2=plateI; %may replace tensor voting
for i=1:3
